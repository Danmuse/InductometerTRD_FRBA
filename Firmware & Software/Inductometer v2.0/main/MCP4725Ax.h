...
//! @brief <b>analogLines_t</b> enumeration indicates the specific Digital-Analog Converter (<tt>DAC</tt>) output selected for the operation. 
typedef enum {
  DAC01 = 0, //!< First Digital-Analog Converter (<tt>DAC</tt>) output of the <tt>MCP4725</tt> Integrated Circuit.
  DAC02 = 1, //!< Second Digital-Analog Converter (<tt>DAC</tt>) output of the <tt>MCP4725</tt> Integrated Circuit.
  DAC03 = 2, //!< Third Digital-Analog Converter (<tt>DAC</tt>) output of the <tt>MCP4725</tt> Integrated Circuit.
  DAC04 = 3, //!< Fourth Digital-Analog Converter (<tt>DAC</tt>) output of the <tt>MCP4725</tt> Integrated Circuit.
  DAC05 = 4, //!< Fifth Digital-Analog Converter (<tt>DAC</tt>) output of the <tt>MCP4725</tt> Integrated Circuit.
  DAC06 = 5, //!< Sixth Digital-Analog Converter (<tt>DAC</tt>) output of the <tt>MCP4725</tt> Integrated Circuit.
  DAC07 = 6, //!< Seventh Digital-Analog Converter (<tt>DAC</tt>) output of the <tt>MCP4725</tt> Integrated Circuit.
  DAC08 = 7, //!< Eighth Digital-Analog Converter (<tt>DAC</tt>) output of the <tt>MCP4725</tt> Integrated Circuit.
  DAC09 = 8, //!< Ninth Digital-Analog Converter (<tt>DAC</tt>) output of the <tt>MCP4725</tt> Integrated Circuit.
  DAC10 = 9  //!< Tenth Digital-Analog Converter (<tt>DAC</tt>) output of the <tt>MCP4725</tt> Integrated Circuit.
} analogLines_t;

//! @brief <b>analogStatus_t</b> enumeration indicates the status of the Digital-Analog Converter (<tt>DAC</tt>) output.
typedef enum {
  ANALOG_NAND = 0, //!< Analog signal is not specified.
...
/*!
 * @brief Increments a variable of type <a href = "./_m_c_p4725_ax_8h.html#a008faacdfb9e0c6140a41279cd82ccaa"><tt>analogLines_t</tt></a>.
 * @param output Variable of type <a href = "./_m_c_p4725_ax_8h.html#a008faacdfb9e0c6140a41279cd82ccaa"><tt>analogLines_t</tt></a> to be incremented.
 * @return Variable of type <a href = "./_m_c_p4725_ax_8h.html#a008faacdfb9e0c6140a41279cd82ccaa"><tt>analogLines_t</tt></a> incremented.
 * @note The operator overloading is not necessary in the <tt>C</tt> programming language.
 */
analogLines_t &operator++(analogLines_t &output);
