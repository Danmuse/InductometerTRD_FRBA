...
#define ST7789_RST_PIN  TFT_RST
// #define ST7789_DC_PORT  GPIOB
#define ST7789_DC_PIN   TFT_DC

#ifndef CFG_NO_CS
// #define ST7789_CS_PORT  ST7789_CS_GPIO_Port
#define ST7789_CS_PIN   TFT_CS
#endif
...
extern uint16_t disp_buf[ST7789_WIDTH * HOR_LEN];
#endif
...
/* Basic operations */
#define ST7789_RST_Clr() digitalWrite(ST7789_RST_PIN, LOW) // HAL_GPIO_WritePin(ST7789_RST_PORT, ST7789_RST_PIN, GPIO_PIN_RESET)
#define ST7789_RST_Set() digitalWrite(ST7789_RST_PIN, HIGH) // HAL_GPIO_WritePin(ST7789_RST_PORT, ST7789_RST_PIN, GPIO_PIN_SET)

#define ST7789_DC_Clr() digitalWrite(ST7789_DC_PIN, LOW) // HAL_GPIO_WritePin(ST7789_DC_PORT, ST7789_DC_PIN, GPIO_PIN_RESET)
#define ST7789_DC_Set() digitalWrite(ST7789_DC_PIN, HIGH) // HAL_GPIO_WritePin(ST7789_DC_PORT, ST7789_DC_PIN, GPIO_PIN_SET)
#ifndef CFG_NO_CS
#define ST7789_Select() digitalWrite(ST7789_CS_PIN, LOW) // HAL_GPIO_WritePin(ST7789_CS_PORT, ST7789_CS_PIN, GPIO_PIN_RESET)
#define ST7789_UnSelect() digitalWrite(ST7789_CS_PIN, HIGH) // HAL_GPIO_WritePin(ST7789_CS_PORT, ST7789_CS_PIN, GPIO_PIN_SET)
#else
#define ST7789_Select() asm("nop")
#define ST7789_UnSelect() asm("nop")
#endif

#define HAL_Delay(time) delay(time);
